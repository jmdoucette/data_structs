...
fn criterion_benchmark(c: &mut Criterion) {
    c.bench_function("add_and_union 100000", |b| b.iter(|| add_and_union(black_box(100000))));
    c.bench_function("add_and_union_no_compression 100000", |b| b.iter(|| add_and_union_no_compression(black_box(100000))));
}
